...
cd $CMSSW_BASE/src/Alignment/OfflineValidation/test/test_yaml_new/PV/single/testUnits/unitTest/317655/
...
cd $CMSSW_BASE/src/Alignment/OfflineValidation/test/test_yaml_new/PV/merge/testUnits/317655/
./PVmerge validation.json || die "Failure running PV merge step" $?
