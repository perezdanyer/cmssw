...
cd $CMSSW_BASE/src/Alignment/OfflineValidation/test/test_yaml/PV/single/testUnits/unitTest/1/
...
cd $CMSSW_BASE/src/Alignment/OfflineValidation/test/test_yaml/PV/merge/testUnits/1/
./PVmerge validation.json --verbose || die "Failure running PV merge step" $?

echo "TESTING PV trends"
cd $CMSSW_BASE/src/Alignment/OfflineValidation/test/test_yaml/PV/trends/testUnits/
