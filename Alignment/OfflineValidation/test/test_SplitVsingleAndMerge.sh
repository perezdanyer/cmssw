...
cd $CMSSW_BASE/src/Alignment/OfflineValidation/test/test_yaml_new/SplitV/single/testUnits/unitTest/1/
...
cd $CMSSW_BASE/src/Alignment/OfflineValidation/test/test_yaml_new/SplitV/merge/testUnits/1/
